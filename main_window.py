...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_new_tasks = QPushButton(self.centralwidget)
        self.btn_new_tasks.setObjectName(u"btn_new_tasks")
        font = QFont()
        font.setPointSize(15)
        self.btn_new_tasks.setFont(font)

        self.horizontalLayout.addWidget(self.btn_new_tasks)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_new_tasks.setText(QCoreApplication.translate("MainWindow", u"+", None))
    # retranslateUi
